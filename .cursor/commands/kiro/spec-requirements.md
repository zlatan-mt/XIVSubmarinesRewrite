...
1. **Load Context**:
   ...
   - Read `plans/specs/specs/$1/requirements.md` for project description
...
2. **Read Guidelines**:
   - Read `plans/specs/settings/rules/ears-format.md` for EARS syntax rules
   - Read `plans/specs/settings/templates/specs/requirements.md` for document structure
...
- Review generated requirements at `plans/specs/specs/$1/requirements.md`
