...
- `plans/specs/specs/$1/spec.json`, `requirements.md`, `design.md` (if exists)
- **Entire `plans/specs/steering/` directory** for complete project memory
- `plans/specs/settings/templates/specs/design.md` for document structure
- `plans/specs/settings/rules/design-principles.md` for design principles
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `plans/specs/settings/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `plans/specs/settings/rules/design-discovery-light.md`
...
1. **Load Design Template and Rules**:
   - Read `plans/specs/settings/templates/specs/design.md` for structure
   - Read `plans/specs/settings/rules/design-principles.md` for principles
...
1. **Status**: Confirm design document generated at `plans/specs/specs/$1/design.md`
...
**Note**: The actual design document follows `plans/specs/settings/templates/specs/design.md` structure.
...
- **User Message**: "No requirements.md found at `plans/specs/specs/$1/requirements.md`"
- **Suggested Action**: "Run `/kiro:spec-requirements $1` to generate requirements first"

**Template Missing**:
- **User Message**: "Template file missing at `plans/specs/settings/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`plans/specs/settings/rules/design-discovery-full.md`)
- **Rationale**: Better to over-research than miss critical context

### Next Phase: Task Generation

**If Design Approved**:
- Review generated design at `plans/specs/specs/$1/design.md`
